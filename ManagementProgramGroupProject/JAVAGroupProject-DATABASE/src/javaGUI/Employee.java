...
class Employee extends JFrame {
    ...
    Employee(String username) {
        ...
        clockLabel = new JLabel("<html><center>Clocked out!!<br>Hours Worked: 0</center></html>");
        clockLabel.setBounds(150,20,200,100);
        ...
        b1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                ...
                clockLabel.setText("<html><center>Clocked in!!</center></html>");
    ...
    private void storeInDatabase() {
    	try {
    		...
    		double hourlyRate = con.getHourlyRate(username);
    		double pay = (double) elapsedSeconds/3600 * hourlyRate * 3600;
    		con.updateDB(username, elapsedSeconds, pay);
...
*/
    ...
    private void updateClock() {
        ...
        String time = String.format("<html><center>Clocked out!!<br>Hours Worked: %02d</center></html>", seconds);
